...
public class User {
	...
	private int rating;
	@NegativeOrZero(message="Invalid bloclisted status.Input number should be valid")
	private int blocklisted;
	@Future(message="Invalid date"
			+ ". It should be provided as a future date ")
	...
	@CreditCardNumber(message="Invalid credit card number.It should not contain should be valid")
	private String creditCardExample;
	
	public User() {}
	
	
	public User(Long userId, String userName, String userEmailId, int age, String currenTimeOfWritingArticles,
